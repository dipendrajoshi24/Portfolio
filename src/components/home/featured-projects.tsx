...
export function FeaturedProjects() {
  // Show the first 2 projects on the homepage
  const featuredProjects = [
    projects.find(p => p.id === "complaint-box"),
    projects.find(p => p.id === "stress-prediction")
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <ScrollReveal delay={0.2} width="100%">
          <motion.div
            ...
            className="text-center mb-10 sm:mb-12 w-full mx-auto"
          >
