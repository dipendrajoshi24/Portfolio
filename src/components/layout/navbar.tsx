    ...
    <AnimatePresence>
      {isVisible && (
        <motion.header
          ...
          exit="exit"
          className={cn(
            "fixed top-2 sm:top-4 left-1/2 -translate-x-1/2 w-[96%] sm:w-[95%] max-w-6xl z-50 transition-all duration-300 rounded-xl py-2.5 sm:py-3 px-3 sm:px-4",
            isScrolled 
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="w-[120px] sm:w-[160px] shrink-0">
              <Link 
                href="/"
                className="font-display text-base sm:text-xl font-bold transition-colors hover:text-primary block truncate"
              >
                <motion.span
                ...
                {NAV_ITEMS.map((item, i) => (
                  ...
                  >
                    <Link
                      href={item.href}
                      className={cn(
                        "px-2.5 lg:px-4 py-2 rounded-md text-sm font-medium transition-all hover:text-primary hover:bg-muted/50 whitespace-nowrap",
                        pathname === item.href
            ...
            <div className="w-[120px] sm:w-[160px] shrink-0 flex justify-end items-center gap-1 sm:gap-2">
              <motion.div
                  ...
                  <SheetContent side="right" className="p-0">
                    <div className="flex flex-col h-full">
                      <div className="p-6 flex justify-between items-center">
                        ...
                        >
                          <span className="gradient-text">Dipendra Joshi</span>
                        </Link>
                        <ThemeToggle />
                      </div>
